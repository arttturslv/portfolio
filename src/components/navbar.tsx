      ...
      <nav className="max-w-[1400px]  items-center w-full flex h-10 px-4  mx-4 sm:mx-12  ">
        <Link href="/">
          <span className="flex group w-16 opacity-0">
            ...
            <h1 className="font-khan  delay-150 font-extrabold text-2xl   group-hover:overflow-hidden group-hover:max-w-0 max-w-[5.4rem] transition-all duration-200 ease-in-out">
              {" "}
              tt
            </h1>
